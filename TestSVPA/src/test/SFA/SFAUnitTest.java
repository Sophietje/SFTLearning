...
public class SFAUnitTest {
	...
	public void testEquivalenceHK() throws TimeoutException {
		...
		assertFalse(autA.isEquivalentPlusSymbolicWitnessTo(autB, ba, 10000).first);
		assertTrue(cUcA.isEquivalentPlusSymbolicWitnessTo(SFA.getFullSFA(ba), ba, 10000).first);
		assertTrue(cUcB.isEquivalentPlusSymbolicWitnessTo(SFA.getFullSFA(ba), ba, 10000).first);
		assertTrue(cUcB.isEquivalentPlusSymbolicWitnessTo(cUcA, ba, 10000).first);
