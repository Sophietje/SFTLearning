...
public class SFA<P, S> extends Automaton<P, S> {
	...
	/**
	 * Checks whether the automaton accepts the same language as aut2
	 * 
	 * @throws TimeoutException
	 */
	...
	/**
	 * Checks whether the aut1 is equivalent to aut2 and returns a concrete witness if not. Second element is null if equivalent.
	 * 
	 * @throws TimeoutException
	 */
	 ...
	 * @throws TimeoutException
	 */
	public Pair<Boolean, List<P>> isEquivalentPlusSymbolicWitnessTo(SFA<P, S> aut, BooleanAlgebra<P, S> ba, long timeout)
			throws TimeoutException {		
